...
Now, to make a new match you need to write the each word/sentence to compare 
in the two availables text fields and then click at the 'Comparar' button;
After that, you will be redirect to the 'Show' page where you can see if the 
words/senteces are in fact an anagram;
